...
Some minor modifications to the `src/App.js` to verify we are able to access
Web3.  The modifications involve changing the title to React-Truffle, importing
Web3, specifying the default Address of our local ethereumjs-testrpc instance,
and performing a basic call to verify our version of web3.
